...
// BrushDoc.cpp : implementation of the CBrushDoc class
//
...
// CBrushDoc construction/destruction

CBrushDoc::CBrushDoc() noexcept
{
...
void CBrushDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CBrushDoc::InitializeSearchContent()
{
...
void CBrushDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
